...
switch Action
    ...
    case 'update'
        ...
        %Plot Skipped
        ndxSkippedCorrect=BpodSystem.Data.Custom.ResponseCorrect(indxToPlot)==1&(BpodSystem.Data.Custom.WaitingTime<BpodSystem.Data.Custom.FeedbackDelay(indxToPlot))&~BpodSystem.Data.Custom.CatchTrial(indxToPlot);
