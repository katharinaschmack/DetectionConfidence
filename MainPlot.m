...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.OutcomePlot.LightGuidance = line(-1,[0 1], 'LineStyle','none','Marker','p','MarkerEdge','m','MarkerFace','none', 'MarkerSize',20);
        ...
        AxesHandles.HandlePsycAud.XLabel.String = 'dB'; % FIGURE OUT UNIT
    ...
    case 'update'
        ...
        set(BpodSystem.GUIHandles.OutcomePlot.LightGuidance, 'xdata', Xdata, 'ydata', Ydata);
        ...
        if TaskParameters.GUI.ShowPsycAud
            ...
            if sum(~ndxNan) > 1
                ...
                BpodSystem.GUIHandles.OutcomePlot.PsycAudFit.YData = glmval(glmfit(AudDV(~ndxNan),...
                    BpodSystem.Data.Custom.ResponseLeft(~ndxNan)','binomial'),linspace(min(AudDV),max(AudDV),100),'logit');
            end
        end
%         %% Vevaiometric
...
%             LeftSkip = sum(~BpodSystem.Data.Custom.Feedback(1:iTrial)&~BpodSystem.Data.Custom.CatchTrial(1:iTrial)&~ndxExclude&BpodSystem.Data.Custom.ResponseLeft(1:iTrial)==1)/sum(~BpodSystem.Data.Custom.CatchTrial(1:iTrial)&~ndxExclude&BpodSystem.Data.Custom.ResponseLeft(1:iTrial)==1);
%             RightSkip = sum(~BpodSystem.Data.Custom.Feedback(1:iTrial)&~BpodSystem.Data.Custom.CatchTrial(1:iTrial)&~ndxExclude&BpodSystem.Data.Custom.ResponseLeft(1:iTrial)==0)/sum(~BpodSystem.Data.Custom.CatchTrial(1:iTrial)&~ndxExclude&BpodSystem.Data.Custom.ResponseLeft(1:iTrial)==0);
