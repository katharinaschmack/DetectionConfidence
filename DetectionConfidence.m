...
sma = AddState(sma, 'Name', 'Cin',...
    ...
    'OutputActions', [StimStartOutput,{'GlobalTimerTrig',1}]);
...
if any(strcmp('Cin',statesThisTrial))
    if any(strcmp('stillSampling',statesThisTrial)) && any(strcmp('lat_Go_signal',statesThisTrial))==0
        if any(strcmp('stillSamplingJackpot',statesThisTrial))
            ...
            BpodSystem.Data.Custom.ST(iTrial) = BpodSystem.Data.RawEvents.Trial{iTrial}.States.Cin(1,end) - BpodSystem.Data.RawEvents.Trial{iTrial}.States.Cin(1,1); % diff(BpodSystem.Data.RawEvents.Trial{iTrial}.States.Cin);
    end
end
