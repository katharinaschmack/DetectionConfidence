...
elseif BpodSystem.Data.Custom.LaserTrial(iTrial)==1
sma = AddState(sma, 'Name', 'StartRecording',...
            'Timer',0.025,...
            'StateChangeConditions', {'Tup', 'startOfTrial'},...
...
% if BpodSystem.Data.Custom.LaserTrial(iTrial)
% 
% sma = AddState(sma, 'Name', 'Cin_PreStim',...
%     'Timer', BpodSystem.Data.Custom.PreStimDuration(iTrial)-.1,...
%     'StateChangeConditions', {CenterPortOut, 'Cout_Grace','Tup','Cin_PreStimLaser','GlobalTimer3_End','Cin_PreStimLaser'},...
%     'OutputActions', [LED.Pre_Stim]);
% 
% sma = AddState(sma, 'Name', 'Cin_PreStimLaser',...
%     'Timer', .1,...
%     'StateChangeConditions', {CenterPortOut, 'Cout_Grace','Tup','Cin_Stim','GlobalTimer3_End','Cin_Stim'},...
%     'OutputActions', [LED.Pre_Stim,{'BNCState',1}]);
% 
% 
% else
    sma = AddState(sma, 'Name', 'Cin_PreStim',...
