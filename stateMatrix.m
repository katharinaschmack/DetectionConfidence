...
sma = AddState(sma, 'Name', 'LinCorrect_CueFb',...
    'Timer', LinCorrect_CueFb_Duration,...
    'StateChangeConditions', {'Tup','LinCorrect_Fb',CorrectPortOut,'EndOfTrial'},...
    'OutputActions', LED.LinCorrect_CueFb);

sma = AddState(sma, 'Name', 'LinCorrect_Fb',...
    'Timer', CorrectValveTime,...
    'StateChangeConditions', {'Tup','LinCorrect_WaitLout',CorrectPortOut,'EndOfTrial'},...
